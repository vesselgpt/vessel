...
with gr.Blocks(theme=gr.themes.Ocean()) as demo:
    ...
    with gr.Tab(label="Vessel"):
        ...
        gr.Markdown(
            ...
            Visit <a href="https://vesselgpt.io/" target="_blank">Katana ML</a> and <a href="https://github.com/vesselgpt/vessel" target="_blank">Vessel</a> GitHub for more details.
            </p>
            <p style="text-align: center;">
