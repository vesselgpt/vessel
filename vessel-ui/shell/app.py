...
def run_inference(image_filepath, query, key):
    ...
    try:
        ...
        url = 'https://vesselgpt-vessel-ml.hf.space/api/v1/vessel-llm/inference'
        headers = {
        ...
        with open(filename, "rb") as f:
            ...
            data = {
                ...
                'options': 'huggingface,vesselgpt/vessel-qwen2-vl-7b'
            }
    ...
    with gr.Tab(label="Vessel UI"):
        with gr.Row():
            with gr.Column():
                ...
                key_input = gr.Textbox(label="Vessel Key", type="password")
        ...
        gr.Markdown(
            ...
            Visit <a href="https://vesselgpt.io/" target="_blank">Katana ML</a> for more details.
            </p>
            """
        )
