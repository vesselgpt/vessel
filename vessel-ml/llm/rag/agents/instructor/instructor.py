...
import instructor
from .helpers.instructor_helper import execute_vessel_processor, merge_dicts, pre_process_pdf, track_query_output
        ...
        if validate_options:
            if options and "tables" in options:
                ...
                for i, page in enumerate(output_files):
                    content, table_contents = execute_vessel_processor(options, page, strategy, model_name, local, debug)
