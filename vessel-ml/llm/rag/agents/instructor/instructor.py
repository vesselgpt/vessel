...
import instructor
from .helpers.instructor_helper import execute_vessel_processor, merge_dicts
    ...
    def run_pipeline(self,
        ...
        if validate_options:
            if options and "tables" in options:
                content, table_contents = execute_vessel_processor(options, file_path, strategy, model_name, local,
                                                                   debug)
