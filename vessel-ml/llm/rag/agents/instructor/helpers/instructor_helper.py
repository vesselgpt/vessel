...
def execute_vessel_processor(options, file_path, strategy, model_name, local, debug):
...
def pre_process_pdf(file_path, convert_to_images):
    ...
    if not convert_to_images:
        ...
        for i, image in enumerate(images):
            ...
            # debug_output_filename = os.path.join("/Users/dldiego1/infra/shared/vessel-git/vessel/vessel-ml/llm/data/", f'page_{i + 1}.jpg')
