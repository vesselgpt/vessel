...
from vessel_parse.helpers.html_extractor_helper import merge_html_table_headers
from vessel_parse.helpers.html_extractor_helper import clean_html_table_header_names
...
if __name__ == "__main__":
    # to run for debugging, navigate above vessel_parse and run the following command:
    # python -m vessel_parse.extractors.html_extractor
