...
if __name__ == "__main__":
    ...
    # output_directory = "/Users/dldiego1/Documents/work/bankstatement/output_pages"
    # # Ensure the output directory exists
    # os.makedirs(output_directory, exist_ok=True)
    #
    # # Split the optimized PDF into separate pages
    # num_pages, output_files, temp_dir = pdf_optimizer.split_pdf_to_pages("/Users/dldiego1/Documents/work/bankstatement/statement.pdf",
    #                                                                      output_directory,
    #                                                                      False)
    #
